    ...
    <!-- main comment -->
      ...
      $write_subComment = "INSERT INTO `wowdyaln_sub_comments` (`id`, `comment_id`, `sub_content`, `created_at`, `user_id`) VALUES (NULL, '{$comment_id}', '{$comment}', CURRENT_TIMESTAMP, '{$user_id}')";
